...
<h2 align="center"> FB FRIEND AND PIBLIC ID  CLONING  LOGIN FB ID OR TOKEN TOOL </h2>

<p align="center">
      LATEST FAST CLONING COMAND  ID LOGIN AND TOKEN LOGIN
</p>
...
$ pkg install git
$ git clone https://github.com/James404-cyber/Pro.git
$ cd Pro
$ python2 hack.py
```
